...
def main(**kwargs):
    ...
    print('1. Ec correspondiente')
    print('2. Libreria Random')
    print('3. Numpy')
    print('4. Los 3 anteriores')

    op = input()
    if op == 1:
        x = Opciones(cantidad, **kwargs)
        valores1, tiempo1 = x.opcion1()
        print("El tiempo en realizar el metodo1 fue {}".format(tiempo1))
        ...
        print("El tiempo en realizar el metodo2 fue {}".format(tiempo2))
        ...
        print("El tiempo en realizar el metodo3 fue {}".format(tiempo3))
        ...
        x = Opciones(cantidad, **kwargs)
        valores2, tiempo2 = x.opcion1()
        valores2, tiempo2 = x.opcion2()
        valores2, tiempo2 = x.opcion3()
        data = []  # Arreglo donde estara la informacion que se manda a archivo
        header = ['No', 'Metodo 1', 'Metodo 2', 'Metodo 3']
        for i in range(cantidad):
            data.append([i+1, valores1[i], valores2[i], valores3[i]])
